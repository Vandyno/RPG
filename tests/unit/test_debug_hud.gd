...
func test_hud_renders_mobile_friendly_status_prompt_and_content_card() -> void:
	...
	for child in hud.root.get_node("ActionButtons").get_children():
		if child is Button and child.text == "Systems":
			child.pressed.emit()
	...
	assert_true(hud.systems_body_label.text.contains("Quest:"))
	assert_true(hud.systems_body_label.text.contains("Quest Targets:"))
	assert_true(hud.systems_body_label.text.contains("E 5.0t Harrow Venn"))
	assert_true(hud.systems_body_label.text.contains("Nearby: Road Notice"))
	assert_true(hud.systems_body_label.text.contains("Detail: Readable: Briarwatch Road Notice"))
	assert_true(hud.systems_body_label.text.contains("Directions:"))
	assert_true(hud.systems_body_label.text.contains("E 5.0t Harrow Venn"))
	target_button.pressed.emit()

	hud.set_systems_tab("world")
	assert_true(hud.systems_body_label.text.contains("Phase: Afternoon"))
	assert_true(hud.systems_body_label.text.contains("Locations: Briarwatch Crossroads"))
	assert_true(hud.systems_body_label.text.contains("Location Details:"))
	assert_true(hud.systems_body_label.text.contains("Briarwatch road meets the old trade track"))
	assert_true(hud.systems_body_label.text.contains("Loaded chunks: 25"))
	assert_true(hud.systems_body_label.text.contains("Progression: Level 2"))
	...
	assert_true(hud.systems_tab_buttons["log"].button_pressed)
	assert_true(hud.systems_body_label.text.contains("Log"))
...
func test_hud_refresh_sanitizes_malformed_state_fields() -> void:
	...
	assert_true(hud.systems_body_label.text.contains("Quest: none"))
	hud.set_systems_tab("log")
	assert_true(hud.systems_body_label.text.contains("Recent: none"))
	hud.toggle_target_picker()
