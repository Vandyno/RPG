...
func test_hud_renders_mobile_friendly_status_prompt_and_content_card() -> void:
	...
	assert_true(hud.systems_body_label.text.contains("Gear, supplies, and valuables."))
	...
	assert_true(hud.systems_body_label.text.contains("Buy and sell with the selected merchant."))
	...
	assert_true(hud.systems_body_label.text.contains("Active work and nearby objectives."))
	...
	assert_true(hud.systems_body_label.text.contains("Time, reputation, and recent events."))
