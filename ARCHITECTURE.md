...
and future schedule hooks. Campfire rest and HUD World-tab wait actions advance
...
The World and Quest tabs may show navigation summaries generated by
...
The World tab should also render discovered-location details from authored
...
- The HUD world panel can show current reputation while testing the spawn yard.
...
the HUD World tab, advanced by rest and wait actions, and available to authored
...
- The HUD World tab exposes small wait actions so time behavior is testable near spawn.
